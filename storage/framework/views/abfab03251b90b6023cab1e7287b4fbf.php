...
<section class="record-profile-summary record-fuel-recharge-summary">
    ...
    <div class="record-summary-main">
        <h2><?php echo e($display($recordPayload['rechargeId'] ?? $record->code)); ?></h2>
        <p>
            Vehicle: <?php echo e($display($vehicleLabel)); ?>

            · Fuel: <?php echo e($display($recordPayload['fuelType'] ?? $primaryFuelName)); ?>

            · Station: <?php echo e($display($primaryStation)); ?>

        </p>
        <div class="record-tags">
            <span class="record-tag <?php echo e($statusClass); ?>"><?php echo e($status); ?></span>
            <span class="record-tag success"><?php echo e($money($totalAmount)); ?></span>
            <span class="record-tag warning"><?php echo e($formatDate($rechargeDate)); ?></span>
        </div>
    </div>

    <div class="record-summary-stats">
        <div class="record-summary-stat"><label>Total Amount</label><div><?php echo e($money($totalAmount)); ?></div></div>
        <div class="record-summary-stat"><label>Primary Qty</label><div><?php echo e($primarySummary); ?></div></div>
        <div class="record-summary-stat"><label>ODO Reading</label><div><?php echo e($number($recordPayload['odoReading'] ?? $recordPayload['endKm'] ?? null)); ?></div></div>
...
<section class="record-detail-card">
    ...
    <div class="record-table-section">
        ...
        <table class="record-info-table"><tbody>
            <tr><th>Contract</th><td><?php echo e($display($contractLabel)); ?></td></tr>
            <tr><th>Contract ID</th><td><?php echo e($display($contractId)); ?></td></tr>
            <tr><th>Contract Label</th><td><?php echo e($display($contractLabel)); ?></td></tr>
        </tbody></table>

        <h4 class="record-sub-title">Vehicle Information</h4>
        <table class="record-info-table"><tbody>
            <tr><th>Vehicle</th><td><?php echo e($display($vehicleLabel)); ?></td></tr>
            <tr><th>Vehicle ID</th><td><?php echo e($display($vehicleId)); ?></td></tr>
            <tr><th>Vehicle Label</th><td><?php echo e($display($vehicleLabel)); ?></td></tr>
        </tbody></table>

        <h4 class="record-sub-title">Assigned Driver</h4>
        <table class="record-info-table"><tbody>
            <tr><th>Driver</th><td><?php echo e($display($driverName)); ?></td></tr>
            <tr><th>Driver ID</th><td><?php echo e($display($driverId)); ?></td></tr>
            <tr><th>Driver Name</th><td><?php echo e($display($driverName)); ?></td></tr>
            <tr><th>Driver Shift</th><td><?php echo e($display($recordPayload['driverShift'] ?? null)); ?></td></tr>
        </tbody></table>
    </div>
</section>
...
<section class="record-detail-card">
    ...
    <div class="record-table-section">
        <div class="record-fuel-photo-grid">
            <?php $__currentLoopData = $photoDefinitions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photoKey => $photoTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <article class="record-fuel-photo-card">
                    <div class="record-fuel-photo-title"><?php echo e($photoTitle); ?></div>
                    <table class="record-fuel-photo-table"><tbody>
                        <tr><th>Time</th><td><?php echo e($display($photo['time'] ?? null)); ?></td></tr>
                        <tr><th>Place</th><td><?php echo e($display($photo['place'] ?? $photo['placeName'] ?? null)); ?></td></tr>
                        <tr><th>Captured</th><td><?php echo e($photoCaptured ? 'Yes' : 'No'); ?></td></tr>
                        <tr><th>Captured At</th><td><?php echo e($formatDateTime($capturedAt)); ?></td></tr>
                    </tbody></table>
                    <div class="record-fuel-photo-preview">
                        <?php if($photoImageUrl !== ''): ?>
                            <a href="<?php echo e($photoImageUrl); ?>" target="_blank" rel="noopener" class="record-fuel-photo-link" aria-label="Open <?php echo e($photoTitle); ?>">
                                <img src="<?php echo e($photoImageUrl); ?>" alt="<?php echo e($photoTitle); ?>">
                            </a>
                            <div class="record-fuel-photo-meta">
                                <strong><?php echo e($fileDescription($photoFile)); ?></strong>
                                <a href="<?php echo e($photoImageUrl); ?>" target="_blank" rel="noopener" class="record-open-btn">Open Image</a>
                            </div>
                        <?php else: ?>
                            <div class="record-template-empty-state">No <?php echo e(strtolower($photoTitle)); ?> information saved.</div>
                        <?php endif; ?>
                    </div>
                </article>
...
<section class="record-detail-card">
    ...
    <div class="record-table-section">
        ...
        <table class="record-info-table"><tbody>
            <tr><th>Main Fuel Name</th><td><?php echo e($display($primaryFuelName)); ?></td></tr>
            <tr><th>Primary Fuel Station</th><td><?php echo e($display($primaryStation)); ?></td></tr>
            <tr><th>Quantity</th><td><?php echo e($primarySummary); ?></td></tr>
            <tr><th>Rate Per Unit</th><td><?php echo e($number($recordPayload['primaryRate'] ?? null)); ?></td></tr>
            <tr><th>Calculated Amount</th><td><?php echo e($money($primaryAmount)); ?></td></tr>
            <tr><th>Pricing Mode</th><td><?php echo e($display($primaryPricingMode)); ?></td></tr>
            <tr><th>Payment Mode</th><td><?php echo e($display($primaryEntryUnit)); ?></td></tr>
        </tbody></table>

        <h4 class="record-sub-title">Second Fuel</h4>
        <table class="record-info-table"><tbody>
            <tr><th>Second Fuel Name</th><td><?php echo e($display($hasSecondaryFuel ? ($recordPayload['secondaryFuelName'] ?? null) : null)); ?></td></tr>
            <tr><th>Secondary Fuel Station</th><td><?php echo e($display($hasSecondaryFuel ? ($recordPayload['secondaryFuelStation'] ?? $recordPayload['secondaryStation'] ?? null) : null)); ?></td></tr>
            <tr><th>Quantity</th><td><?php echo e($hasSecondaryFuel ? $number($secondaryEnteredValue) . ($secondaryEntryUnit !== '' ? ' '.$secondaryEntryUnit : '') : '—'); ?></td></tr>
            <tr><th>Rate Per Unit</th><td><?php echo e($hasSecondaryFuel ? $number($recordPayload['secondaryRate'] ?? null) : '—'); ?></td></tr>
            <tr><th>Calculated Amount</th><td><?php echo e($hasSecondaryFuel ? $money($recordPayload['secondaryAmount'] ?? null) : '—'); ?></td></tr>
            <tr><th>Pricing Mode</th><td><?php echo e($display($hasSecondaryFuel ? ($recordPayload['secondaryPricingMode'] ?? null) : null)); ?></td></tr>
        </tbody></table>

        <h4 class="record-sub-title">Total Fuel Cost</h4>
        <table class="record-info-table"><tbody>
            <tr><th>Total Fuel Cost</th><td><?php echo e($money($totalAmount)); ?></td></tr>
        </tbody></table>
    </div>
</section>
...
<section class="record-detail-card">
    ...
    <div class="record-table-section">
        ...
        <table class="record-info-table"><tbody>
            <tr><th>Start KM</th><td><?php echo e($number($recordPayload['startKm'] ?? null)); ?></td></tr>
            <tr><th>End KM</th><td><?php echo e($number($recordPayload['endKm'] ?? null)); ?></td></tr>
            <tr><th>Total KM</th><td><?php echo e($number($totalKm)); ?></td></tr>
            <tr><th>Mileage</th><td><?php echo e($number($recordPayload['mileage'] ?? null)); ?></td></tr>
            <tr><th>TK/KM</th><td><?php echo e($number($recordPayload['tkKm'] ?? null)); ?></td></tr>
            <tr><th>ODO Reading</th><td><?php echo e($number($recordPayload['odoReading'] ?? $recordPayload['endKm'] ?? null)); ?></td></tr>
        </tbody></table>

        <h4 class="record-sub-title">Submission Information</h4>
        <table class="record-info-table"><tbody>
            <tr><th>Status</th><td><span class="record-tag <?php echo e($statusClass); ?>"><?php echo e($status); ?></span></td></tr>
            <tr><th>Submitted By</th><td><?php echo e($display($recordPayload['submittedBy'] ?? null)); ?></td></tr>
            <tr><th>Remarks</th><td><?php echo e($display($recordPayload['remarks'] ?? null)); ?></td></tr>
            <tr><th>Date</th><td><?php echo e($formatDate($rechargeDate, 'Y-m-d')); ?></td></tr>
        </tbody></table>
    </div>
</section>
...
<section class="record-detail-card">
    ...
    <div class="record-table-section">
        ...
        <table class="record-info-table"><tbody>
            ...
            <tr><th>Recharge Validation Version</th><td><?php echo e($display($recordPayload['rechargeValidationVersion'] ?? null)); ?></td></tr>
        </tbody></table>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/FleetManagement/resources/views/fleetman/record-details/fuel_recharges.blade.php ENDPATH**/ ?>