...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal315c571ce40dc0c12ed885ba8a594408 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal315c571ce40dc0c12ed885ba8a594408 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fleetman.section-card','data' => ['title' => '6. Documents','class' => 'document-section-card']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('fleetman.section-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => '6. Documents','class' => 'document-section-card']); ?>
...
<?php $component->withAttributes(['items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['label' => 'Employee List']])]); ?>
             <?php $__env->slot('actions', null, []); ?> 
                ...
                <?php if(data_get($fleetman, 'auth.pageAccess.canManage')): ?>
                    <a href="<?php echo e(route('fleet.employees', ['action' => 'add'])); ?>" class="btn primary" id="addEmployeeFromListBtn">＋ Add Employee</a>
                <?php else: ?>
...
<?php endif; ?>
            ...
            <div class="table-wrap employee-table"><table><thead><tr><th>Created At</th><th>Employee</th><th>Contacts</th><th>Designation</th><th>Joining Date</th><th>Salary</th><th>Status</th><th>Present Address</th><th>Docs</th><th>Expiring Documents</th><th>Actions</th></tr></thead><tbody id="employeeTbody"></tbody></table></div>
        </div>
    </div>
</div>
