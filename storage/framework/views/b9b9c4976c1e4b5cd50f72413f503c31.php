...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fleetman.entity-avatar','data' => ['file' => $user->profile_photo_path ?? '','fallback' => $userInitials !== '' ? $userInitials : 'U','alt' => $user->name.' profile picture','size' => 'compact']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['file' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user->profile_photo_path ?? ''),'fallback' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($userInitials !== '' ? $userInitials : 'U'),'alt' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user->name.' profile picture'),'size' => 'compact']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
