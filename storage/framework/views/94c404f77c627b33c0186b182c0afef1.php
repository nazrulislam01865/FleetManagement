<?php $__env->startSection('title', 'Daily Driver & Fuel Report | FleetMan'); ?>
<?php $__env->startSection('mobile-title', 'Daily Report'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fleetman.topbar','data' => ['items' => [['label' => 'Reports', 'route' => 'fleet.reports'], ['label' => 'Daily Driver & Fuel Report']]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['label' => 'Reports', 'route' => 'fleet.reports'], ['label' => 'Daily Driver & Fuel Report']])]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fleetman.title-card','data' => ['title' => 'Daily Driver & Fuel Report','subtitle' => 'Daily report for driver working time, fuel use, odometer movement, mileage, and submission status. The report stays inside a fixed laptop-screen box.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Daily Driver & Fuel Report','subtitle' => 'Daily report for driver working time, fuel use, odometer movement, mileage, and submission status. The report stays inside a fixed laptop-screen box.']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fleetman.report-filter-card','data' => ['title' => 'Report Filters']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Report Filters']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fleetman.report-shell','data' => ['title' => 'Report Result','tableMinWidth' => '2280px']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Report Result','table-min-width' => '2280px']); ?>
