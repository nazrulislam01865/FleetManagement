<?php $__env->startSection('title', 'Weekly Driver Fuel Summary Report | FleetMan'); ?>
<?php $__env->startSection('mobile-title', 'Weekly Report'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fleetman.topbar','data' => ['items' => [['label' => 'Reports', 'route' => 'fleet.reports'], ['label' => 'Weekly Driver Fuel Summary']]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['label' => 'Reports', 'route' => 'fleet.reports'], ['label' => 'Weekly Driver Fuel Summary']])]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fleetman.title-card','data' => ['title' => 'Weekly Driver Fuel Summary Report','subtitle' => 'Week starts on Saturday and ends on Friday. The report is kept inside a fixed box, so users scroll only inside the report area.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Weekly Driver Fuel Summary Report','subtitle' => 'Week starts on Saturday and ends on Friday. The report is kept inside a fixed box, so users scroll only inside the report area.']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fleetman.report-filter-card','data' => ['title' => 'Report Filters','subtitle' => 'Select week and optional filters. Report table stays inside fixed laptop screen space.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Report Filters','subtitle' => 'Select week and optional filters. Report table stays inside fixed laptop screen space.']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.fleetman.report-shell','data' => ['title' => 'Report Result','subtitle' => 'Only this report box has horizontal scrolling. Page layout remains fixed.','tableMinWidth' => '2680px']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Report Result','subtitle' => 'Only this report box has horizontal scrolling. Page layout remains fixed.','table-min-width' => '2680px']); ?>
...
<?php echo $__env->make('layouts.fleetman', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/FleetManagement/resources/views/fleetman/reports/weekly-driver-fuel.blade.php ENDPATH**/ ?>